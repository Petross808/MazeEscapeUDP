...
public class CameraScript : MonoBehaviour
{
    ...
    [SerializeField, Range(10, 90)] private int _maxVerticalAngle = 80;
    ...
    public void AimChanged(Vector2 delta)
    {
        ...
        newRotation.x = Mathf.Clamp((-Mathf.DeltaAngle(rotationEuler.x, 0) - (delta.y * _cameraSensitivity.y)), -_maxVerticalAngle, _maxVerticalAngle);
